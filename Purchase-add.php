...
$sql = "INSERT INTO `purchases` (`Medicine Name`, `Category`, `Supplier`, `Cost`, `Quantity`, `Date of Purchase`, `Expiry Date`) 
       VALUES (?, ?, ?, ?, ?, ?, ?)";
$stmt = $conn->prepare($sql);
$stmt->bind_param("sssiiss", $medicinename, $category, $supplier, $cost, $quantity, $dateofpurchase, $expiryDate);
$stmt->execute();
