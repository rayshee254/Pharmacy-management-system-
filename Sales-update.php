...
if (isset($_GET['med'])) {
    ...
    $qry1 = "SELECT * FROM sales WHERE `Medicine Name`='$medicineName'";
...
<input type="number" name="cid" value="<?php echo $row['Customer ID']; ?>"><br>
</p>
<p>
...
<input type="number" name="total" value="<?php echo $row['Total price']; ?>"><br>
</p>
<p>
<label for="payment">Payment Method:</label>
<input type="text" name="payment" value="<?php echo $row['Payment method']; ?>"><br>
</p>
<p>
