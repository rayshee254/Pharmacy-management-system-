...
<aside class="sidebar">
	...
	<table  id="table1" >
    <caption>STOCK PURCHASE LIST</caption>
    <tr>
        <th>Medicine Name</th>
        <th>Category</th>
        <th>Supplier</th>
...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        echo "<a class='button1 edit-btn' href='Purchase-update.php?mid=".$row['Medicine Name']."&cat=".$row['Category']."&sup=".$row['Supplier']."&qty=".$row['Quantity']."&date=".$row['Date of Purchase']."&exp=".$row['Expiry Date']."'>Edit</a>";
echo "<a class='button1 del-btn' href='Purchase-delete.php?mid=".$row['Medicine Name']."&cat=".$row['Category']."&sup=".$row['Supplier']."&qty=".$row['Quantity']."&date=".$row['Date of Purchase']."&exp=".$row['Expiry Date']."'>
