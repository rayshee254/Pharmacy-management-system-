...
<aside class="sidebar">
            <div class="profile">
                ...
                <img src="logo 3.png" alt="Quickfix Pharmacy" class="logo">
            </div>
    ...
    <section class="dashboard-cards">
        <a href="Purchase-add.php">
            <div class="card">
                ...
                </span></br> Add Purchases<br><span></span>
            </div>
        </a>
        ...
        <a href="Suppliers-add.php">
            <div class="card">
               ...
               Add Suppliers<br><span></span>
            </div>
        </a>
        <a href="invoices-view.php">
            <div class="card">
                <br><span class="icon">
