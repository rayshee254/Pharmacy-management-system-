...
<aside class="sidebar">
    ...
    <caption>CUSTOMER LIST</caption>
        ...
        <?php
    include "config.php";
    $sql = "SELECT `Customer ID`, `First Name`, `Last Name`, `Product`, `Payment method`, `Phone number`, `Date` FROM customers";
    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            echo "<tr>";
                ...
                echo "<a class='button1 edit-btn' href='Customers-update.php?cid=" . $row['Customer ID'] . "&fname=" . $row['First Name'] . "&lname=" . $row['Last Name'] . "&pdt=" . $row['Product'] . "&pmd=" . $row['Payment method'] . "&phone=" . $row['Phone number'] . "&date=" . $row['Date'] . "'>Edit</a>"; 
                echo "<a class='button1 del-btn' href='Customers-delete.php?cid=" . $row['Customer ID'] . "&fname=" . $row['First Name'] . "&lname=" . $row['Last Name'] . "&pdt=" . $row['Product'] . "&pmd=" . $row['Payment method'] . "&phone=" . $row['Phone number'] . "&date=" . $row['Date'] . "'><ion-icon name='trash-outline'></ion-icon></a>";
