...
if (isset($_POST['add'])) {
    ...
    $sql = "INSERT INTO `customers` (`Customer ID`, `First Name`, `Last Name`, `Product`, `Payment method`, `Phone number`, `Date`) VALUES (?, ?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ississi", $id, $fname, $lname, $product, $payment_method, $phno, $date);
    $stmt->execute();
